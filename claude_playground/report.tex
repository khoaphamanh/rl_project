...
\title{iML Project Report Template}
...
Here you cite related papers, either by referring to \cite{wever-aaai26a} or as a reference at the end of the sentence~\citep{wever-aaai26a}. 
...
\begin{algorithm}[H]
    \caption{A great iML method adaptation.}
    \label{alg:code}
    \begin{algorithmic}
        \Require Dataset $D$, algorithm $A$
        \Return explanation $\alpha$
        \While TRUE
            \State Train $A$ on $D$
        \EndWhile
    \end{algorithmic}
